...
def reset_cfg(cfg, args):
    ...
    if args.STM_LEN:
        cfg.STM_LEN = args.STM_LEN

    if args.K_NUM:
        cfg.K_NUM = args.K_NUM

    if args.NUM_HEAD:
        cfg.NUM_HEAD = args.NUM_HEAD
...
def main(args):
    ...
    if args.eval_only:
        ...
        _, thr_val = trainer.test(split="val", thr=None)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file", type=str, default="./configs/trainers/CLIP/vit_b16.yaml", help="path to config file")
    ...
    parser.add_argument("--trainer", type=str, default="CLIP", help="name of trainer")
